...
<div class="content-area" id="primary">
    <main class="site-main page-template-landing-page" id="main">
        <div data-aos="fade-right" class="landing-left"
            ...
            <div class="address">
                <a target="_blank"
                    href="<?php echo get_field("church_google_maps_link"); ?>"><?php echo get_field("church_address"); ?></a> | <a
                    href="tel:<?php echo get_field("church_phone_number"); ?>"><?php echo get_field("church_phone_number"); ?></a>
            </div>
            <?php endif; ?>
        ...
        <div data-aos="fade-left" class="landing-right"
            ...
            <div class="address">
                <a target="_blank"
                    href="<?php echo get_field("school_google_maps_link"); ?>"><?php echo get_field("school_address"); ?></a> |
        ...
        <div class="address">
            <a target="_blank"
                href="<?php echo get_field("landing_google_maps_link"); ?>"><?php echo get_field("landing_address"); ?></a> | <a
                href="tel:<?php echo get_field("landing_phone_number"); ?>"><?php echo get_field("landing_phone_number"); ?></a>
        </div>
        <?php endif; ?>
    </main>
</div>