...
$filename = "aquinas_$blog_id-custom-variables";
...
$variables->addCssRule(
    ...
    array(
        ...
        "--menu-quicklinks-default-font-color" => get_field('menu_colors', 'options')['quicklinks_default']['default_font_color'],
        "--menu-quicklinks-hover-font-color" => get_field('menu_colors', 'options')['quicklinks_default']['font_color_hover'],
        "--menu-quicklinks-default-bg-color" => getBgColor(get_field('menu_colors', 'options')['quicklinks_default']['default_bg_color'], get_field('menu_colors', 'options')['quicklinks_default']['default_bg_color_is_gradient']),
        "--menu-quicklinks-hover-bg-color" => getBgColor(get_field('menu_colors', 'options')['quicklinks_default']['bg_color_hover'], get_field('menu_colors', 'options')['quicklinks_default']['bg_color_hover_is_gradient']),
        ...
        "--sticky-menu-quicklinks-default-font-color" => get_field('menu_colors', 'options')['quicklinks_sticky']['default_font_color'],
        "--sticky-menu-quicklinks-hover-font-color" => get_field('menu_colors', 'options')['quicklinks_sticky']['font_color_hover'],
        "--sticky-menu-quicklinks-default-bg-color" => getBgColor(get_field('menu_colors', 'options')['quicklinks_sticky']['default_bg_color'], get_field('menu_colors', 'options')['quicklinks_sticky']['default_bg_color_is_gradient']),
        "--sticky-menu-quicklinks-hover-bg-color" => getBgColor(get_field('menu_colors', 'options')['quicklinks_sticky']['bg_color_hover'], get_field('menu_colors', 'options')['quicklinks_sticky']['bg_color_hover_is_gradient']),
        ...
        "--sidebar-top-level-toggle-bg-color" => getBgColor(get_field('menu_colors', 'options')['top_level_sidebar']['toggle_bg_color'], get_field('menu_colors', 'options')['top_level_sidebar']['toggle_bg_color_is_gradient']),
...
$variables->addCssRule(
    ".crosses line",
    array(
        "stroke" => get_field("shape_color", "options")
    )
);
