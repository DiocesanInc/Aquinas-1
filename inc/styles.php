...
function getCustomStylesFilename()
{
    ...
    return "aquinas_$blog_id-custom-variables";
}

function aquinasStyles()
{
    /**
     * Slick
     */
    ...
    $hash = filemtime(get_parent_theme_file_path() . "/style.css");
...
add_action('wp_enqueue_scripts', 'aquinasStyles');
...
function addEditorStyles()
{
    ...
    if (class_exists("CssHelper") && file_exists(WP_PLUGIN_DIR . "/css-helper/aquinas-custom-variables.css")) {
        add_editor_style("../../plugins/css-helper/aquinas-custom-variables.css");
    } else {
