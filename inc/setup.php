...
if (!function_exists('aquinas_setup')) :
    /**
     ...
     */
    function aquinas_setup()
    {
        /*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on Aquinas, use a find and replace
		 * to change 'aquinas' to the name of your theme in all the template files.
		 */
        load_theme_textdomain('aquinas', get_template_directory() . '/languages');
        ...
        register_nav_menus(
            array(
                'menu-1' => esc_html__('Primary', 'aquinas'),
                'quicklinks' => esc_html__('Quick Links', 'aquinas'),
                // 'footer-quicklinks-top' => esc_html__('Footer Quicklinks Top', 'aquinas'),
                'footer-quicklinks-bottom' => esc_html__('Footer Quicklinks', 'aquinas'),
            )
        );
        ...
        add_theme_support(
            'custom-background',
            apply_filters(
                'aquinas_custom_background_args',
                array(
...
add_action('after_setup_theme', 'aquinas_setup');
 ...
 */
function aquinas_content_width()
{
    $GLOBALS['content_width'] = apply_filters('aquinas_content_width', 640);
}
add_action('after_setup_theme', 'aquinas_content_width', 0);
 ...
 */
function aquinas_widgets_init()
{
    register_sidebar(
        array(
            'name'          => esc_html__('Sidebar', 'aquinas'),
            'id'            => 'sidebar-1',
            'description'   => esc_html__('Add widgets here.', 'aquinas'),
...
add_action('widgets_init', 'aquinas_widgets_init');
